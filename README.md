...
- **Nuxt UI + Tailwind CSS v4**: Accessible UI components, dark mode (default), a Telegram-style animated theme toggle (View Transition API), fonts, and icons via Nuxt UI; Tailwind v4 integrated through the Vite plugin.
